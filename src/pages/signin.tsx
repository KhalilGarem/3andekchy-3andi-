...
const SigninPage: React.FC = () => {
  return (
    <main className="flex h-screen w-screen items-center justify-center overflow-hidden pt-16">
      <div className="container">
        <div className=" -mx-4 flex flex-wrap ">
          <div className="grid w-full grid-cols-2 px-4">
            {/* Login & Art Section */}
            <div className="rounded-l-box flex items-center bg-white px-[150px]">
                ...
                <div>
                  <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <blockquote className="font-noto text-2xl">
                      “انتِ عليك بالحركة وربي عليه بالبركة”
                    </blockquote>
                  </div>
                </div>
                {/* Login */}
                <div>
                  <h3 className="text-body-color mb-6 text-center font-amaranth text-3xl font-bold text-primary">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <span className="flex items-center justify-center gap-4">
                      ...
                      <p className="font-roboto font-semibold">Or</p>
                      <span className="block h-[1px] w-[155px] bg-slate-400 "></span>
                    </span>
                    <FacebookAuth />
                  </div>
            ...
            <div>
              <img
                ...
                className="rounded-r-box h-[800px] w-full object-cover"
                alt=""
              />
            </div>
          </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      >
        ...
        <span className="font-roboto font-semibold">Sign in with Google</span>
      </button>
    </div>
  );
};
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      >
        ...
        <span className="font-roboto font-semibold">Sign in with Facebook</span>
      </button>
    </div>
  );
};
